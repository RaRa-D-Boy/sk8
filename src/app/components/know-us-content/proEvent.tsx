...
const ProEvent = () => {
    return (
        <div className="text-black px-6 py-4 text-[15px] h-[auto] lg:h-[750px] overflow-scroll">
            <div  className="block lg:hidden">
                <Image src={SK88} alt="img" className="w-full h-[450px] rounded-2xl"/>
            </div>
            <h1  className="p-3"><strong>Join Us for Thrilling Skating Adventures at Our Monthly Pro Event!</strong></h1>
